 ...
 */
export async function createGame(client: Client, message: Message, gameData: Collection<Snowflake, object>): Promise<{ collection: Collection<Snowflake, object>, embed: MessageEmbed}> {
